            ...
            <div className="grid md:grid-cols-2 gap-12 items-start">
              ...
              >
                ...
                <div className="mt-8 h-64 bg-gray-200 rounded-lg overflow-hidden">
                    <iframe src="https://drive.google.com/file/d/1sYHzWZKM1L3EqrtF__o_33RH5m8YXz0R/preview" width="100%" height="100%" title="Map showing FORVOQ office location in Angamaly, Kerala" className="w-full h-full object-cover border-0" />
                </div>
              </motion.div>
