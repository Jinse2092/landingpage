          ...
          <div className="container mx-auto px-4">
            <div className="grid md:grid-cols-2 gap-12 items-start">
              ...
              >
                ...
                <div className="mt-8 h-[45rem] w-[45rem] rounded-lg flex items-center justify-center mx-auto" style={{ background: 'transparent' }}>
                    <img src="/forvoqlogo.png" alt="FORVOQ logo" style={{ width: '98%', height: '98%', objectFit: 'contain', background: 'transparent' }} />
                </div>
              </motion.div>
